  ...
  return (
    ...
    <Container>
      ...
      <p className='p-2'>
          ...
          <br></br>
          The API was built using NodeJS, Express, Mongoose and MongoDB, and can be found <a id='api-link' href='https://football-teams-rest-api-assignment.onrender.com/api/' target={'_blank'} rel={"noreferrer"} >here</a>. This app was built using React, React Bootstrap, and CSS.
      </p>
      <p className='p-2'>
