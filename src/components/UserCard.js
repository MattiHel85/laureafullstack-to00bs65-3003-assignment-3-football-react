...
function TeamCard(props) {
  ...
  return (
    ...
    <Card style={{ width: '25rem', margin: '15px',border: 'solid rgb(60, 0, 90)'}}>      
      <Card.Img variant="top" src={props.profilePicUrl} alt={`Profile picture for ${props.firstName} ${props.lastName}`} style={{backgroundColor: "rgb(60, 0, 90)", padding: "20px", height: "350px"}}/>
